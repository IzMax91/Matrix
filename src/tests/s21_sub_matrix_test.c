...
START_TEST(s21_sub_matrix_test_1) {
  ...
  mat_A_1.matrix[0][1] = 4.0;
  mat_A_1.matrix[1][0] = 6.0;
  mat_A_1.matrix[1][1] = 8.0;
  ...
  int error_code = s21_sub_matrix(&mat_A_1, &mat_B_1, &res_1);
  ck_assert_int_eq(error_code, 0);

  ck_assert_double_eq(res_1.matrix[0][0], 1.0);
  ck_assert_double_eq(res_1.matrix[0][1], 2.0);
  ck_assert_double_eq(res_1.matrix[1][0], 3.0);
  ...
  mat_B_2.matrix[0][0] = 2.2;
  mat_B_2.matrix[1][0] = 4.4;
  mat_B_2.matrix[2][0] = 6.6;

  error_code = s21_sub_matrix(&mat_A_2, &mat_B_2, &res_2);
  ck_assert_int_eq(error_code, 0);

  ck_assert_double_eq(res_2.matrix[0][0], 1.1 - 2.2);
  ck_assert_double_eq(res_2.matrix[1][0], 2.2 - 4.4);
  ck_assert_double_eq(res_2.matrix[2][0], 3.3 - 6.6);
  ...
  mat_B_3.matrix[0][0] = 21.3456789;

  error_code = s21_sub_matrix(&mat_A_3, &mat_B_3, &res_3);
  ck_assert_int_eq(error_code, 0);

  ck_assert_double_eq(res_3.matrix[0][0], 12.3456789 - 21.3456789);
...
Suite *s21_sub_matrix_test() {
  Suite *s;
  TCase *tc_sub_matrix_test_1, *tc_sub_matrix_test_2;

  s = suite_create("s21_sub_matrix");

  tc_sub_matrix_test_1 = tcase_create("s21_sub_matrix_test_1");
  tcase_add_test(tc_sub_matrix_test_1, s21_sub_matrix_test_1);
  suite_add_tcase(s, tc_sub_matrix_test_1);

  tc_sub_matrix_test_2 = tcase_create("s21_sub_matrix_test_2");
  tcase_add_test(tc_sub_matrix_test_2, s21_sub_matrix_test_2);
  suite_add_tcase(s, tc_sub_matrix_test_2);
